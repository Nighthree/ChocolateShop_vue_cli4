<template>
  <div>
    <Banner></Banner>
    <Cart></Cart>
    <section class="py-4 mb-5 container-fluid bg-lightChoco" data-aos="fade-up">
      <div class="container">
        <div class="row">
          <div
            class="col-12 col-md-6 text-center p-0 p-md-4 d-flex align-items-center justify-content-center"
          >
            <article>
              <h4 class="h1 mb-3 font-weight-bold">我們的任務</h4>
    ...
    <section class="container mb-5" data-aos="fade-up">
      <h4 class="h1 mb-3 font-weight-bold textStyle text-center">我們的堅持</h4>
      <p class="textStyle h5 text-secondary text-center">
        堅持給您最優良品質的巧克力
        <br />堅持手工製作
        <br />堅持 100% Made in Taiwan
        <br />堅持冷藏運輸新鮮到家
      </p>
      <div class="d-flex justify-content-center pb-5 pt-3">
        ...
        <div class="row flex-row flex-md-row-reverse">
          <div class="col-md-6 col-12 d-flex flex-column justify-content-between pt-4">
            ...
            <div class="d-flex justify-content-end">
              <router-link to="/know" class="p-3 text-Choco">
                看更多巧克力吃的好處
