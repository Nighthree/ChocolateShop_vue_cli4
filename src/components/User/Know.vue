    ...
    <section class="container py-5 textStyle">
      ...
      <div class="row py-4" data-aos="fade-up">
        ...
        <div class="col-md-6 col-12 d-flex align-items-center p-4">
          <img class="img-fluid rounded" src="../../assets/images/know-4.jpg" alt />
        </div>
      </div>
      ...
      <div class="row py-4" data-aos="fade-up">
        ...
        <div class="col-md-6 col-12 d-flex align-items-center p-4">
          <img class="img-fluid rounded" src="../../assets/images/know-1.jpg" alt />
        </div>
      </div>
      ...
      <div class="row flex-row flex-md-row-reverse py-4" data-aos="fade-up">
        ...
        <div class="col-md-6 col-12 d-flex align-items-center p-4">
          <img class="img-fluid rounded" src="../../assets/images/know-2.jpg" alt />
        </div>
      </div>
    </section>
  </div>
